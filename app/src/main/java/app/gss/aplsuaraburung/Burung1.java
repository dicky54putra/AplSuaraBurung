...
public class Burung1 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burung1);
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mp1 =  MediaPlayer.create(this, R.raw.lovebird1);
        mp2 =  MediaPlayer.create(this, R.raw.lovebird2);
        mp3 =  MediaPlayer.create(this, R.raw.lovebird3);
        mp4 =  MediaPlayer.create(this, R.raw.lovebird4);
        mp5 =  MediaPlayer.create(this, R.raw.lovebird5);
        mp6 =  MediaPlayer.create(this, R.raw.lovebird6);
        mp7 =  MediaPlayer.create(this, R.raw.lovebird7);
        mp8 =  MediaPlayer.create(this, R.raw.lovebird8);
        mp9 =  MediaPlayer.create(this, R.raw.lovebird9);
        mp10 =  MediaPlayer.create(this, R.raw.lovebird10);
        mp11 =  MediaPlayer.create(this, R.raw.lovebird11);
        mp12 =  MediaPlayer.create(this, R.raw.lovebird12);
        mp13 =  MediaPlayer.create(this, R.raw.lovebird13);
        mp14 =  MediaPlayer.create(this, R.raw.lovebird14);
        mp15 =  MediaPlayer.create(this, R.raw.lovebird15);
        mp16 =  MediaPlayer.create(this, R.raw.lovebird16);
...
//        final MediaPlayer mp1 = MediaPlayer.create(this, R.raw.lovebird16);
//        bt_suara1.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        });
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.suara1) {
            if (mp2.isPlaying()) {
                ...
                mp14.pause();
                mp14.seekTo(0);
            } else if (mp15.isPlaying()) {
                mp15.pause();
                mp15.seekTo(0);
            } else if (mp16.isPlaying()) {
                mp16.pause();
                mp16.seekTo(0);
            }
            ...
            startActivity(new Intent(Burung1.this, Burung1mp3.class));
            finish();
            ...
            startActivity(new Intent(Burung1.this, Burung1video.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(Burung1.this, HalamanUtama.class));
        finish();
    }
