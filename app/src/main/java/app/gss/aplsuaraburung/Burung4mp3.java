...
public class Burung4mp3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burung4mp3);
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.play1) {
            ...
            /** Menjalankan Audio */
            mediaPlayer1.start();
            Toast.makeText(Burung4mp3.this, "Playing Audio", Toast.LENGTH_SHORT).show();
            ...
            if (mediaPlayer1.isPlaying()) {
                ...
                Toast.makeText(Burung4mp3.this, "Stop Audio", Toast.LENGTH_SHORT).show();
                btnPlay1.setVisibility(View.VISIBLE);
                btnPause1.setVisibility(View.GONE);
            }
            ...
            mediaPlayer13 = MediaPlayer.create(this, Uri.parse("https://firebasestorage.googleapis.com/v0/b/aplsuaraburung.appspot.com/o/burunglain%2Fmp3cck13.mp3?alt=media&token=257ce3b4-7934-427e-bcf8-323ac14782f6"));
            ...
            mediaPlayer14 = MediaPlayer.create(this, Uri.parse("https://firebasestorage.googleapis.com/v0/b/aplsuaraburung.appspot.com/o/burunglain%2Fmp3cck14.mp3?alt=media&token=38922936-96ef-475f-899a-0fe9ff1efbf9"));
            ...
            mediaPlayer15 = MediaPlayer.create(this, Uri.parse("https://firebasestorage.googleapis.com/v0/b/aplsuaraburung.appspot.com/o/burunglain%2Fmp3cck15.mp3?alt=media&token=628dde79-0c2f-4726-996a-369f3c948dfb"));
    ...
    public void onBackPressed() {
        startActivity(new Intent(Burung4mp3.this, Burung4.class));
        finish();
    }
}
